...
TextureShader::TextureShader(struct ShaderPayload &payload) : PhongShader(payload){
...
BumpShader::BumpShader(struct ShaderPayload &payload) : PhongShader(payload){
...
DisplacementShader::DisplacementShader(struct ShaderPayload &payload) : PhongShader(payload){
    float kh = 0.2, kn = 0.1; // scaling
